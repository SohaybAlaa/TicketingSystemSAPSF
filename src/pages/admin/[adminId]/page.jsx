    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-5 flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">HR Support Dashboard</h1>
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p
                      className={`text-3xl font-semibold mb-1 ${card.alert && card.value > 0
                        ? "text-red-600"
                        : "text-slate-900"
                        }`}
                    >
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3 pb-4 border-b border-slate-200">
              ...
              <div className="flex-1">
                <p className="text-slate-900 font-medium">New ticket assigned: TKT-2025-002</p>
            ...
            <div className="flex items-start gap-3 pb-4 border-b border-slate-200">
              ...
              <div className="flex-1">
                <p className="text-slate-900 font-medium">SLA breach alert: TKT-2025-006</p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p className="text-slate-900 font-medium">Ticket completed: TKT-2025-004</p>
