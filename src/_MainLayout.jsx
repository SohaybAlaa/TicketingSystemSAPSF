...
export default function MainLayout({ children }) {
  ...
  useEffect(() => {
    ...
    const getPageTitle = () => {
      if (pathname === `/`) return "";
      if (pathname === `/admin/${adminId}`) return t("home");
      ...
      if (pathname === `/admin/${adminId}/tickets`) return t("tickets");
      if (pathname === `/admin/${adminId}/analytics`) return t("analytics");
      if (pathname === `/admin/${adminId}/documents`) return t("documents");
      return "";
    };
  ...
  return (
    <div className="flex h-screen bg-gray-50">
        ...
        >
          ...
          <div className="flex items-center justify-between px-7 py-7 border-b border-gray-700/80 shadow-lg shadow-yellow-400/5">
            <div className={isMobile ? "text-center flex-1" : "flex-1"}>
              <h2
                className={`text-white text-3xl font-bold drop-shadow-[0_0_10px_rgba(250,204,21,0.3)] mb-1.5 ${
                  preferredLanguage === "ar" ? "tracking-wide" : ""
                }`}
                style={
              ...
              <p
                className={`text-gray-300 text-base ${
                  preferredLanguage === "ar" ? "tracking-wide mt-1" : ""
                }`}
                style={
          ...
          <div className="px-7 py-5 border-t border-gray-700/80">
            <p className="text-gray-400 text-sm font-medium mb-1.5">V0.1</p>
            <p
      ...
      <div
        ...
        style={{
          marginLeft:
            !isMobile && isSidebarOpen && preferredLanguage === "en"
              ? "22rem"
              : "0",
          marginRight:
            !isMobile && isSidebarOpen && preferredLanguage === "ar"
              ? "22rem"
              : "0",
        }}
      >
