...
export default function Admin() {
  const adminId = "EmadOmar"; // temporary hardcoded ID
  const navigate = useNavigate(); // ✅ this replaces router.push
    ...
    <div className="">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="-mt-10 mb-5">
          ...
          <p className="text-slate-600 text-base">Welcome back, {adminId}</p>
        </div>
      </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3 pb-4 border-b border-slate-200">
              ...
              <div className="flex-1">
                <p className="text-slate-900 font-medium">New ticket assigned: TKT-2024-002</p>
                <p className="text-slate-600">Unable to access HR portal - CRITICAL priority</p>
              </div>
            ...
            <div className="flex items-start gap-3 pb-4 border-b border-slate-200">
              ...
              <div className="flex-1">
                <p className="text-slate-900 font-medium">SLA breach alert: TKT-2024-006</p>
                <p className="text-slate-600">Resolution time exceeded for vacation leave approval</p>
              </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p className="text-slate-900 font-medium">Ticket completed: TKT-2024-004</p>
                <p className="text-slate-600">Health insurance coverage query resolved</p>
              </div>
